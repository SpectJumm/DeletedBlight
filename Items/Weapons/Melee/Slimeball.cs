...
namespace ShadowlightMod.Items.Weapons.Melee
{
    public class Slimeball : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = Item.buyPrice(0, 0, 50, 0); // The amount of money that the item is can be bought for.

            Item.shoot = ModContent.ProjectileType<SlimeballProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
    ...
    public class KingSlimeDrops : GlobalNPC
    {
        public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
        {
            ...
            {
                npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Slimeball>(), 4)); // 25% chance to drop
            }
        }
    }
}
