        ...
        public override void SetStaticDefaults() {
			...
			if (!Main.dedServ) {
				...
				GameShaders.Armor.BindShader(
					Item.type,
					new ArmorShaderData(Mod.Assets.Request<Effect>("Assets/AutoloadedEffects/Shaders/Dyes/FirstShader"), "ArmorNoise")
					.UseImage(Mod.Assets.Request<Texture2D>("Assets/Textures/Noise/PerlinNoise"))
				);
			}
        }
